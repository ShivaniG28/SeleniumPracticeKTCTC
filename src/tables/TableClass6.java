...
System.setProperty("webdriver.chrome.driver", "C:\\Driver\\Dr\\chromedriver.exe");
		...
		{
			String cName = driver.findElement(By.xpath("//*[@class ='dataTable']//tr["+i+"]/td[1]/a")).getText();
			System.out.println(cName);
			
			String cntPrice = driver.findElement(By.xpath("//*[@class ='dataTable']//tr["+i+"]/td[4]")).getText();
